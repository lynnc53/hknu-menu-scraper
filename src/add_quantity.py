...
def add_quantity_to_menus():

    # import all required dataframes 
    df_yummy = pd.read_csv("data/hknu_merged_yummy_menus.csv")
    df_healthy = pd.read_csv("data/hknu_merged_healthy_menus.csv")
